...
# package-ffmpeg.sh
#
# Assembles the separate ESM and UMD artifacts for @ffmpeg/ffmpeg into a
...
validate_package() {
  ...
  local critical_files=(
    ...
    "$target_dir/dist/umd/ffmpeg.js"
  )
  echo "  - Running validation for @ffmpeg/ffmpeg..."
...
# --- Main Execution ---
echo "--- Packaging @ffmpeg/ffmpeg ---"
ESM_ARTIFACT_DIR="dist/esm"
UMD_ARTIFACT_DIR="dist/umd"
SOURCE_PKG_DIR="packages/ffmpeg"
...
VERSIONED_DIR="builds/ffmpeg@${PKG_VERSION}"
LATEST_DIR="builds/ffmpeg"
...
echo ""
echo "✅ Successfully packaged and validated @ffmpeg/ffmpeg@${PKG_VERSION}."